...
export default function HomePage() {
  return (
    <main className="min-h-screen bg-slate-950 text-slate-100">
      <section className="border-b border-white/5 px-6 py-6 sm:px-10 lg:px-16">
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-6">
          ...
          <div className="ml-auto hidden items-center gap-3 lg:flex">
            <Link href="/login" className="rounded-full border border-slate-800/90 bg-slate-900/80 px-5 py-3 text-sm font-semibold text-slate-100 transition hover:border-slate-700 hover:bg-slate-800">
              Sign in
            </Link>
        ...
        <div className="mx-auto grid max-w-7xl gap-16 lg:grid-cols-[1.2fr_0.8fr] lg:items-center">
          <div className="space-y-8">
            <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.65 }}>
              <p className="inline-flex items-center gap-2 rounded-full border border-sky-500/20 bg-sky-500/10 px-4 py-2 text-sm font-medium text-sky-300">
            ...
            <motion.p initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.65, delay: 0.2 }} className="max-w-2xl text-lg leading-8 text-slate-400">
            ...
            <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.65, delay: 0.3 }} className="flex flex-col gap-4 sm:flex-row sm:items-center">
              ...
              <Link href="/dashboard" className="inline-flex items-center justify-center rounded-full border border-slate-800 bg-slate-900/80 px-6 py-3 text-base font-semibold text-slate-100 transition hover:border-slate-700">
                Explore platform
              </Link>
            </motion.div>
            ...
            <div className="grid gap-4 sm:grid-cols-3">
              {heroHighlights.map((item) => (
                <motion.div
                  ...
                  className="rounded-[1.75rem] border border-slate-800/90 bg-slate-950/80 p-5"
                >
          ...
          <motion.div initial={{ opacity: 0, scale: 0.96 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.7, delay: 0.2 }} className="rounded-[2rem] border border-slate-800/90 bg-slate-900/80 p-8 shadow-glow backdrop-blur-xl">
            <div className="space-y-6">
              <div className="rounded-[1.75rem] bg-slate-950 p-6 shadow-soft">
                <div className="flex items-center justify-between gap-4">
                  <div>
                    <p className="text-sm uppercase tracking-[0.28em] text-sky-300">Risk monitoring</p>
                    <h2 className="mt-3 text-2xl font-semibold text-white">AI-enabled risk profiling</h2>
                  </div>
                  <div className="rounded-3xl bg-sky-500/10 px-4 py-2 text-sm font-semibold text-sky-300">Live</div>
                </div>
                <div className="mt-6 grid gap-4 sm:grid-cols-2">
                  {trustStats.slice(0, 4).map((item) => (
                    <div key={item.label} className="rounded-3xl border border-slate-800/90 bg-slate-950/90 p-4">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                {trustStats.slice(4).map((item) => (
                  <div key={item.label} className="rounded-3xl border border-slate-800/80 bg-slate-950/80 p-5">
                    <p className="text-sm text-slate-400">{item.label}</p>
      ...
      <section id="features" className="px-6 py-20 sm:px-10 lg:px-16">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 max-w-2xl">
            <p className="text-sm uppercase tracking-[0.3em] text-sky-300">Capabilities</p>
            <h2 className="mt-4 text-4xl font-semibold text-white">Complete student risk and success orchestration.</h2>
      ...
      <section id="how-it-works" className="bg-slate-900/80 px-6 py-20 sm:px-10 lg:px-16">
        <div className="mx-auto max-w-7xl">
          <div className="grid gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
            <div className="space-y-6">
              <p className="text-sm uppercase tracking-[0.3em] text-sky-300">How it works</p>
              <h2 className="text-4xl font-semibold text-white">From data collection to academic intervention.</h2>
            ...
            <div className="rounded-[2rem] border border-slate-800/90 bg-slate-950/80 p-8 shadow-glow">
              <div className="space-y-6">
                <div className="rounded-3xl border border-slate-800/90 bg-slate-900 p-6">
                  <div className="flex items-center justify-between gap-4">
                    <div>
                      <p className="text-sm uppercase tracking-[0.3em] text-sky-300">Model highlight</p>
                      <h3 className="mt-3 text-2xl font-semibold text-white">Explainable predictions with strong performance</h3>
                    </div>
                    <div className="rounded-3xl bg-sky-500/10 px-4 py-2 text-sm font-semibold text-sky-300">AI inside</div>
                  </div>
                </div>
                <div className="grid gap-4 sm:grid-cols-2">
                  {mlHighlights.map((item) => (
                    <div key={item.label} className="rounded-3xl border border-slate-800/90 bg-slate-950/90 p-5">
                      <p className="text-sm text-slate-400">{item.label}</p>
      ...
      <section id="analytics" className="px-6 py-20 sm:px-10 lg:px-16">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 max-w-2xl">
            ...
            <h2 className="mt-4 text-4xl font-semibold text-white">University insights that drive faster decisions.</h2>
            <p className="mt-4 text-lg leading-8 text-slate-400">
          ...
          <div className="grid gap-8 lg:grid-cols-[0.95fr_1.05fr]">
            <div className="grid gap-6 sm:grid-cols-2">
              {analyticsMetrics.map((metric) => (
                <div key={metric.label} className="rounded-[2rem] border border-slate-800/90 bg-slate-950/80 p-6 shadow-soft">
                  <p className="text-sm uppercase tracking-[0.28em] text-slate-400">{metric.label}</p>
                  <p className="mt-4 text-3xl font-semibold text-white">{metric.value}</p>
                </div>
              ))}
            </div>
            <div className="rounded-[2rem] border border-slate-800/90 bg-slate-950/80 p-8 shadow-soft">
              <div className="flex items-center justify-between gap-4">
                <div>
                  <p className="text-sm uppercase tracking-[0.28em] text-slate-400">Explainability</p>
                  <h3 className="mt-3 text-2xl font-semibold text-white">Feature importance for risk predictions</h3>
                </div>
                <div className="rounded-3xl bg-sky-500/10 px-4 py-2 text-sm font-semibold text-sky-300">SHAP-ready</div>
              </div>
      ...
      <section className="bg-slate-900/80 px-6 py-20 sm:px-10 lg:px-16">
        <div className="mx-auto max-w-7xl">
          <div className="grid gap-12 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
            <div className="space-y-6">
              <p className="text-sm uppercase tracking-[0.3em] text-sky-300">Platform preview</p>
              <h2 className="text-4xl font-semibold text-white">Role-based console previews for every academic user.</h2>
              <p className="max-w-xl text-lg leading-8 text-slate-400">
                Students, lecturers, advisors, and administrators each get dashboards tailored to their priorities and workflows.
              </p>
              <div className="grid gap-4 sm:grid-cols-2">
                {whyCards.map((card) => (
                  <div key={card.title} className="rounded-3xl border border-slate-800/90 bg-slate-950/90 p-5">
        ...
        <div className="mx-auto max-w-7xl">
          <div className="rounded-[2rem] border border-slate-800/90 bg-slate-950/80 p-8 shadow-soft">
            <div className="grid gap-10 lg:grid-cols-[0.75fr_1.25fr] lg:items-center">
              <div className="space-y-6">
                <p className="text-sm uppercase tracking-[0.3em] text-sky-300">Student success score</p>
                <h2 className="text-4xl font-semibold text-white">See every student’s progress in a single view.</h2>
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                {demoFeatures.map((feature) => (
                  <div key={feature.label} className="rounded-3xl border border-slate-800/90 bg-slate-900 p-5">
      ...
      <section id="faq" className="bg-slate-900/80 px-6 py-20 sm:px-10 lg:px-16">
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 max-w-2xl">
            <p className="text-sm uppercase tracking-[0.3em] text-sky-300">FAQ</p>
            <h2 className="mt-4 text-4xl font-semibold text-white">Questions from university decision makers.</h2>
          </div>
      ...
      <section className="px-6 py-20 sm:px-10 lg:px-16">
        <div className="mx-auto max-w-7xl">
          <div className="rounded-[2rem] border border-slate-800/90 bg-slate-950/80 p-10 text-center shadow-glow">
            <p className="text-sm uppercase tracking-[0.3em] text-sky-300">Ready to transform student outcomes?</p>
            <h2 className="mt-4 text-4xl font-semibold text-white">Bring predictive student support to UniPort today.</h2>
            ...
            <div className="mt-8 flex flex-col items-center justify-center gap-4 sm:flex-row">
              ...
              <Link href="/contact" className="inline-flex items-center justify-center rounded-full border border-slate-800 bg-slate-900/80 px-7 py-4 text-base font-semibold text-slate-100 transition hover:border-slate-700">
                Contact sales
              </Link>
            </div>
          </div>
      ...
      <footer className="border-t border-slate-800/80 px-6 py-10 sm:px-10 lg:px-16">
        <div className="mx-auto flex max-w-7xl flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <p className="text-lg font-semibold text-white">UAEWSS</p>
